...
CREATE TABLE `Project` (
  ...
  `video` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
--
-- 資料表結構 `projects_tools`
--

CREATE TABLE `projects_tools` (
  `project_id` int UNSIGNED NOT NULL,
  `tool_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `projects_tools`
--
ALTER TABLE `projects_tools`
  MODIFY `project_id` int UNSIGNED NOT NULL AUTO_INCREMENT;
